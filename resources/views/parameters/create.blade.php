                    ...
                    <form method="POST" action="{{ route('parameters.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                   ...
                                   placeholder="contoh: pH, COD, BOD, TDS..." required>
                        </div>

                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Merek/Tipe Alat</label>
                            <input type="text" name="instrument" value="{{ old('instrument') }}"
                                   class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="category" value="{{ old('category') }}" 
                                   class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                   placeholder="contoh: Kimia, Fisika, Mikrobiologi...">
                        </div>

                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Metode Default</label>
                            <input type="text" name="default_method" value="{{ old('default_method') }}" 
                                   class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                   placeholder="contoh: Titrimetri, Spektrofotometri...">
                        </div>

                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Satuan Default</label>
                            <input type="text" name="default_unit" value="{{ old('default_unit') }}" 
                                   class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                   placeholder="contoh: mg/L, ppm, CFU/mL...">
                        </div>
