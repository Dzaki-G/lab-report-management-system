                ...
                <div class="p-8">
                    ...
                    <form method="POST" action="{{ route('form.store') }}" id="formPengujian">
                        ...
                        <div class="mb-8 p-6 bg-amber-50/50 border border-amber-100 rounded-2xl shadow-sm" id="sp3DetailsSection" style="display:none">
                            ...
                            <p class="text-sm text-gray-500 mb-5">Isi nomor SP3, No. SPPP, dan Instruksi Kerja untuk setiap parameter yang dipilih. Muncul otomatis saat parameter diceklis.</p>
                ...
                checked.forEach(paramId => {
                    if (!document.querySelector(`.sp3-detail-row[data-parameter-id="${paramId}"]`)) {
                        ...
                        row.innerHTML = `
                            ...
                            <div>
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-2">No. SPPP <span class="text-red-500">*</span></label>
